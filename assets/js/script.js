...
function assignQuestions(operand1){
    ...
    //It provides random numbers that can be used to select the questions from the questions array
...
/**
 * It takes the assignedQuestions array and starts showing it in the DOM 
 */
function showQuestions(operand1){
